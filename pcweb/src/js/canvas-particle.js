...
window.CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var obj = document.getElementsByClassName("softDev")[0];
...
//		body.style.margin = "0";
		...
		obj.onmousemove = function(e){
			...
			canvas.mouse = {
				x: event.clientX,
				y: event.clientY-$(".softDev").offset().top+$("body").scrollTop()
			}
	...
	function canvasSize(canvas){
		canvas.width = parseInt($(".softDev").css("width"));
		canvas.height =parseInt($(".softDev").css("height"));
	}
